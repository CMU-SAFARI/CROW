...
.model  nmos_access_tran  nmos  level = 54
...
+tnom    = 27              toxe    = 3.1e-009        toxp    = 3.1e-009          toxm    = 3.1e-009      
+dtox    = 0          epsrox  = 3.9             wint    = 5e-009          lint    = 0             
+ll      = 0               wl      = 0               lln     = 1               wln     = 1             
+lw      = 0               ww      = 0               lwn     = 1               wwn     = 1             
+lwl     = 0               wwl     = 0               xpart   = 0               toxref  = 1.2e-009      

+vth0    = 0.83191         k1      = 0.4             k2      = 0               k3      = 0             
...
+tnom    = 27              toxe    = 1.6e-009        toxp    = 1.6e-009          toxm    = 1.6e-009      
+dtox    = 0          epsrox  = 3.9             wint    = 5e-009          lint    = 0             
+ll      = 0               wl      = 0               lln     = 1               wln     = 1             
+lw      = 0               ww      = 0               lwn     = 1               wwn     = 1             
+lwl     = 0               wwl     = 0               xpart   = 0               toxref  = 1.2e-009      
...
+tnom    = 27              toxe    = 1.6e-009       toxp    = 1.6e-009          toxm    = 1.6e-009     
+dtox    = 0        epsrox  = 3.9             wint    = 5e-009          lint    = 8e-010        
+ll      = 0               wl      = 0               lln     = 1               wln     = 1             
+lw      = 0               ww      = 0               lwn     = 1               wwn     = 1             
